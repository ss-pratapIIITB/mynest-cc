...
**Prep note.** `Arrays.binarySearch` exists, but interviewers want the hand-rolled version — precisely to see whether you handle the bounds. Write it from muscle memory so you can spend your attention on the harder variants below.
