...
export const PILLARS: Pillar[] = [
  ...
  },
  {
    ...
    name: "Environment Design (Situated Cognition)",
    category: "gap",
    relatedSkills: ["Focus", "Recovery", "Prioritization"],
    whyItMatters:
      "Situated cognition — the idea, developed across cognitive science as the '4E' framework (embodied, embedded, enacted, extended) — argues that thinking was never a purely in-the-skull process. It's shaped by the physical, social, and digital spaces you do it in. The clearest version of this is Barbara Tversky's research (The Knowledge Project, episode #146, 'Action Shapes Thought', and her book Mind in Motion): her Nine Laws of Cognition include 'spatial thinking is the foundation of abstract thought' and, most useful here, 'when thought overflows the mind, the mind puts it back into the world' — we're built to externalize cognition into notebooks, whiteboards, and room layout, not to hold it all internally through sheer willpower. Andy Clark and David Chalmers made the same case philosophically with the 'extended mind' thesis: your notebook, your desk, and the people around you are literally part of your thinking apparatus, not just aids to it. This reframes your Focus (84) differently than the Flow pillar does: raw willpower is a finite, effortful resource, but a well-designed environment does the enforcing for you, for free, every time you walk into it. It's also a direct, non-metaphorical link to your reported brain fog and back pain — physical clutter and a poorly set up workspace are a measurable cognitive load (the Zeigarnik effect: every visible unfinished thing quietly taxes attention), not just an aesthetic annoyance.",
    weeklyActions: [
      "Redesign one environment this week for a single explicit purpose — the desk for deep work only, not email; the meeting room for decisions, not status updates.",
      "Run a 10-minute clutter sweep of your primary workspace before the week starts — every visible open loop is attention tax whether you notice it consciously or not.",
      "Move your phone out of arm's reach for every deep-work block. Proximity, not willpower, is what actually predicts whether you check it.",
      "Externalize instead of memorizing: put anything you're 'holding in your head' onto a whiteboard, notebook, or wall. Tversky's research says this isn't a crutch — it's how cognition is supposed to work.",
      "Audit your physical setup against the brain fog and back pain you're already logging in the check-in: chair height, screen height, natural light, air — treat it as an environment bug to fix, not a willpower failure to push through.",
    ],
    books: [
      { title: "Mind in Motion", author: "Barbara Tversky", why: "The Knowledge Project episode that likely sparked this pillar (#146, 'Action Shapes Thought') — the full research behind why space and action, not raw willpower, are the foundation of clear thinking." },
      { title: "The Extended Mind", author: "Annie Murphy Paul", why: "A business-reader-friendly case for treating your notebook, your room, and the people around you as literal extensions of your thinking, not just aids to it." },
      { title: "Nudge", author: "Richard Thaler & Cass Sunstein", why: "The definitive text on choice architecture — how the default settings of an environment quietly decide outcomes before any conscious decision gets made." },
    ],
    milestones: [
      "Redesign your daily defaults (phone placement, desk, notebook) so focus and presence are the default, not a discipline",
      "Design your team's meeting and work environments as deliberately as your own — right room and tools for the kind of thinking that room needs to produce",
      "Build environments and defaults that scale a team's judgment without you personally enforcing it in every room",
      "Shape the environment of the boardroom itself — what gets decided well in that room becomes a design choice, not luck",
      "Reading a room's cognitive affordances is second nature — as automatic as reading a financial statement",
    ],
  },
  {
...
export const DEFAULT_HABITS: HabitDefault[] = [
  ...
  { id: "h16", label: "Externalize one thing you're holding in your head", cadence: "daily", pillarId: "environment-design" },
  ...
  { id: "h17", label: "10-min clutter sweep of primary workspace", cadence: "weekly", pillarId: "environment-design" },
